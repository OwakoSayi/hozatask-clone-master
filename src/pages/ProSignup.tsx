        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <AnimatedField delay={300}>
                <div className="group">
                  <Label className="text-base transition-colors group-focus-within:text-primary">Confirm Password *</Label>
                  <div className="relative mt-1.5">
                    <Input
                      type={showPassword ? "text" : "password"}
                  ...
                  {errors.confirm_password && (
                    <p className="text-sm text-destructive mt-1 animate-fade-in">{errors.confirm_password}</p>
                  )}
                </div>
              </AnimatedField>
